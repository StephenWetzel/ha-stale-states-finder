...
max_allowed_ratio = 4 # ratio between longest gap seen in last 2 weeks and current gap
min_required_count = 30 # only look at entities with at least this number of states reporting in the period
